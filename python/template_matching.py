...
template = cv2.imread('./images/one_yuan_coin.png')
...
cv2.rectangle(src_img, maxLoc, (maxLoc[0] + tw, maxLoc[1] + th), (255, 0, 0), 2)
...
template = cv2.imread('./images/eye_template.png')
...
while True:
    ...
    cv2.rectangle(frame, maxLoc, (maxLoc[0] + tw, maxLoc[1] + th), (255, 0, 0), 2)
