...
cv2.drawContours(src_img, contours, -1, (0, 0, 255), 1, lineType=cv2.LINE_AA)
...
for contour in contours:
    ...
    cv2.circle(src_img, (x, y), 7, (0, 0, 255), 1, lineType=cv2.LINE_AA)

    cv2.arrowedLine(src_img, (x, y), (x + v0[0], y + v0[1]),
                    (0, 255, 0), 2, tipLength=0.25, line_type=cv2.LINE_AA)

    cv2.arrowedLine(src_img, (x, y), (x + v1[0], y + v1[1]),
                    (200, 75, 0), 2, tipLength=0.5, line_type=cv2.LINE_AA)


cv2.imshow("rice contours", src_img)
