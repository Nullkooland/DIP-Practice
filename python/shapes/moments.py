...
if __name__ == "__main__":
    ...
    img_raw = cv2.imread('./images/opencv_logo.png', cv2.IMREAD_UNCHANGED)
    img_src = cv2.cvtColor(img_raw[..., :3], cv2.COLOR_BGR2RGB)
    mask = img_raw[..., 3]
    # load shape template
    img_template = cv2.imread(
        './images/opencv_logo_part.png', cv2.IMREAD_GRAYSCALE)
