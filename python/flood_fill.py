...
def test_predefined_seed():
    reader = ImageReader()
    src_img = reader.read("images/moonbear.heic")
...
def test_userdefined_seed():
    ...
    cv2.setMouseCallback("Watershed", on_mouse,
                         param=(src_img, draw_img, markers))
...
if __name__ == "__main__":
    test_predefined_seed()
    test_userdefined_seed()
